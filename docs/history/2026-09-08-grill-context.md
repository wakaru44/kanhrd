...
This is the raw glossary produced during the grill session that shaped
kanhrd on 2026-09-08, before this repo existed. It was written into the
herdr repo (github.com/others/herdr:CONTEXT.md, branch explore/web-ui)
during a live design conversation and moved here for preservation.

The living glossary is docs/CONTEXT.md — that is what should be updated
when terms evolve. This file is frozen and records what the model
looked like at the moment the decisions were locked in.
-->
